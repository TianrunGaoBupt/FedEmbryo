...
from mains.embryo_pretrain.runner_no_folds import *
# from mains.embryo_pretrain.runner import *
# from mains.embryo_pretrain.multimodal_runner import *
...
if __name__ == '__main__':
    ...
    label_info = json_load('output/0124-centralized-mt/emb_pretrain_resnet50_raw/exp-pid/tasks/label_info.json')
    config = {
        'task': '0124-centralized-mt/emb_pretrain_resnet50_raw',
        'id_base': 'pid',
